...
app.server.on('error',async error=>{console.error(error.code==='EADDRINUSE'?'Mandate is already using port 8410. Open the existing app; no fallback port was started.':error.message);await app.close();process.exitCode=1;});
