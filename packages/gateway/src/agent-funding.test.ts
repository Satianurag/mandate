...
function setup(options:{settlementFails?:boolean;stopDuringSign?:boolean;balance?:bigint}={}){
 ...
 const input:AgentFundingOptions={authority,journal,rpcUrl:'https://mainnet.base.org',facilitatorUrl:'http://127.0.0.1:8426',
